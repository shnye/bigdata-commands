...
```shell
#查看topic
bin/kafka-topics.sh --zookeeper 192.168.86.31:2181 --list
```
...
--broker-list 8.134.123.119 --topic topic_lai
```

```shell
#创建消费者
bin/kafka-console-consumer.sh \
--bootstrap-server 192.168.86.30:9092 --topic topic_iaas_model_practice --from-beginning
```
